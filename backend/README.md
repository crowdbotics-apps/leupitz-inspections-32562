...
## Project Structure
    ...
    ├── leupitz_inspections_32562  # Django project configurations
...
1. Clone this repo and `cd leupitz_inspections_32562`
...
2. Clone this repo and `cd leupitz_inspections_32562`
